  ...
  return (
    <div className='signup template d-flex justify-content-center align-items-center vh-100 bg-primary'>
      <div className='form_container p-5 rounded bg-white'>
        <form onSubmit={handleSignup}> {/* Added onSubmit event handler */}
          ...
          <div className='mb-2'>
            ...
            />
            {usernameError && <div className='text-danger'>{usernameError}</div>} {/* Display username error message */}
          </div>
          <div className='mb-2'>
          ...
          <div className='d-grid mt-2'>
            <button type="submit" className='btn btn-primary'>Sign Up</button> {/* Added type="submit" */}
          </div>
